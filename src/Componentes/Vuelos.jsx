...
function App() {
  const alertClicked1 = () => {
    alert('Numero para reservar tu vuelo: #########');
  };

  const alertClicked2 = () => {
    alert('Estamos trabajando en esta opcion');
  };
        ...
        <div class="grid-container">
          <div class="grid-item">
            <Accordion flush alwaysOpen>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <img src="https://blog.properati.com.co/wp-content/uploads/2021/02/23-co-cartagena.jpg" alt="Cartagena" className="accordion-image"></img>
                  <h1>Cartagena</h1>
                </Accordion.Header>
                <Accordion.Body>
                  ...
                  <Dropdown>
                    <Dropdown.Toggle variant="success" id="dropdown-basic">
                      lugar de partida : precio aproximado
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
                  ...
                  <Button variant="dark">Aparte ya!</Button>
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="1">
                <Accordion.Header>
                  <img src="https://www.upb.edu.co/es/imagenes/img-sobrelaciudadbucaramanga-cam-1464102319822.jpg" alt="Bucaramanga" className="accordion-image"></img>
                  <h1>Bucaramanga</h1>
                </Accordion.Header>
                <Accordion.Body>
          ...
          <div class="grid-item">
            <Accordion flush alwaysOpen>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <img src="https://www.ul.edu.co/uleduco/cache/mod_roksprocket/488cd8edefde50940f7cbae84cefa34f_350_500.jpg" alt="Barranquilla" className="accordion-image"></img>
                  <h1>Barranquilla</h1>
                </Accordion.Header>
                <Accordion.Body>
              ...
              <Accordion.Item eventKey="1">
                <Accordion.Header>
                  <img src="https://upload.wikimedia.org/wikipedia/commons/5/56/Noche_en_Medellin.jpg" alt="Medellin" className="accordion-image"></img>
                  <h1>Medellin</h1>
                </Accordion.Header>
                <Accordion.Body>
        ...
        <div class="grid-container2">
          <div class="item1grid2">
            <ListGroup>
              ...
              <ListGroup.Item action onClick={alertClicked1}>
          ...
          <ListGroup>
            ...
            <ListGroup.Item action onClick={alertClicked2}>
              Reserva ya en linea
            </ListGroup.Item>
          </ListGroup>
        </div>
